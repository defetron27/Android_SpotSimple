...
public class SpeechService extends Service
{
    ...
    private void fetchAccessToken()
    {
        ...
        mAccessTokenTask = new AccessTokenTask(SpeechService.this);
    ...
    {
        private WeakReference<SpeechService> serviceWeakReference;

        public AccessTokenTask(SpeechService speechService)
        {
            this.serviceWeakReference = new WeakReference<>(speechService);
        }

        @Override
        protected AccessToken doInBackground(Void... voids)
        {
            final SharedPreferences prefs = serviceWeakReference.get().getSharedPreferences(PREFS, Context.MODE_PRIVATE);
            ...
            final InputStream stream = serviceWeakReference.get().getResources().openRawResource(R.raw.credential);
            try
            {
        ...
        protected void onPostExecute(AccessToken accessToken)
        {
            ...
            serviceWeakReference.get().mAccessTokenTask = null;
            final ManagedChannel channel = new OkHttpChannelProvider()
                    ...
                    .intercept(new GoogleCredentialsInterceptor(new GoogleCredentials(accessToken)
                            .createScoped(SCOPE)))
                    .build();
            serviceWeakReference.get().mApi = SpeechGrpc.newStub(channel);

            if (mHandler != null)
            {
                mHandler.postDelayed(serviceWeakReference.get().mFetchAccessTokenRunnable,
